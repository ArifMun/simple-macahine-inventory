            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <form action="{{ url('auth-logout') }}" method="POST">
                        @csrf
                        <button type="submit" style="border: none !important;background:none !important">Logout<i
                                class="fas fa-arrow-circle-right"
                                onclick="return confirm('Apakah Anda yakin ingin logout?')"></i></button>
                    </form>
                </li>
            </ul>
        </nav>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ url('machine') }}" class="nav-link {{ $url == 'machine' ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('brand-type') }}"
                                class="nav-link {{ $url == 'brand-type' ? 'active' : '' }}">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Data Jenis dan Merk
                                </p>
